...
<div id="divValue" style="display: none;">${Name}</div>
	<h1 id="tital1">${Name} File Initial Statistical Analysis</h1>
    	<textarea id="message" rows="10" cols="150">${Message}</textarea>
    	<br>
	<div class = "Results">
		<div id="modal-isi-body"></div>
    	<p id="tital2">${Name} ready for graphing.
    	For calculating additional statistical data, click Recalculate.
    	Otherwise, click Graph.</p>
    	
    	<!-- Trigger for object Switch -->
  		<button id="BuildRecord" onclick="SwichLoadout()">Recalculate</button>

  		<!-- Trigger the modal with a button -->
  		<button id="LoadFile" onclick="loadModal('0')">Graph</button>
	</div>
