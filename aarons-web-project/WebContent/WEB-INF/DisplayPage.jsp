...
<h1 id="tital1">${Name} File Raw Data</h1>
    <textarea id="message" rows="12" cols="200">${Message}</textarea>
    <br>
    <p id="tital2">Data associated with set ${Name} ready for statistical calculations.
    To generate statistical data with ${Name}, click Calculate.
    To obtain data under a different name, click Restart.</p>
    <!-- Trigger for object Switch -->
  	<button id="BuildRecord" onclick="SwichLoadout(1)">Calculate</button>

  	<!-- Trigger the modal with a button -->
  	<button id="LoadFile" onclick="loadModal('1')">Restart</button>
</div>
