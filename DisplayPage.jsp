...
<div class = "Populate">
	...
	<form action="BuildRecord" id="Servlet" method="post">
    	<fieldset>
    		...
    		<input type="checkbox" name="operation" id="srth" value="SortHi" checked /><label for="srth">Sort Highest to Lowest</label><br />
    		<input type="checkbox" name="operation" id="srtl" value="SortLo" checked /><label for="srtl">Sort Lowest to Highest</label><br />
    		<input type="checkbox" name="operation" id="ave" value="Average" checked /><label for="ave">Find the Average</label><br />
    		<input type="checkbox" name="operation" id="mid" value="Median" checked /><label for="mid">Find the Median</label><br />
    		<input type="checkbox" name="operation" id="mode" value="Mode" checked /><label for="mode">Find the Mode</label><br />
    		<input type="checkbox" name="operation" id="min" value="Min" checked /><label for="min">Find the Lowest value</label><br />
    		<input type="checkbox" name="operation" id="max" value="Max" checked /><label for="max">Find the Highest value</label><br />
